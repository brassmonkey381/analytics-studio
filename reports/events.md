...
- **50** Was shown the PRO offer (63.3% of top)
- **11** Started a PRO trial (13.9% of top)
...
28 sessions · 63 events · 0 accounts + 21 guests · median session 4s
...
| Event | Fired | People |
| --- | ---: | ---: |
| Viewed a page (`page.view`) | 41 | 16 |
| Session started (`session.start`) | 22 | 16 |
