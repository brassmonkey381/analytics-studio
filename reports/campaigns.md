...
Collected 2026-08-17T05:46:13.937Z. All-time unless a window is named.
...
No campaign-tagged arrival, all time. Landing routes are recorded (31 of 32 sessions, first on 2026-08-14) but not one has ever carried a code, so this zero cannot yet be told apart from a build that has not shipped — see qr_campaign_capture below.
...
| --- | ---: | ---: | ---: | ---: | --- |
| Michi-Maker | 235 | 112 | 1 | 3 | a code was recorded 2026-08-13 |
| TCGScan | 219 | 167 | 0 | 45 | routes yes, never a code — a zero cannot be told from an unshipped build |
| Doggle | 43 | 42 | 1 | 43 | a code was recorded 2026-08-13 |
| Pickleague | 32 | 31 | 0 | 32 | routes yes, never a code — a zero cannot be told from an unshipped build |
