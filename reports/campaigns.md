...
Collected 2026-08-24T16:43:37.649Z. All-time unless a window is named.
...
No campaign-tagged arrival, all time. Landing routes are recorded (223 of 296 sessions, first on 2026-08-06) but not one has ever carried a code, so this zero cannot yet be told apart from a build that has not shipped — see qr_campaign_capture below.
...
No campaign-tagged arrival, all time. Landing routes are recorded (48 of 51 sessions, first on 2026-08-14) but not one has ever carried a code, so this zero cannot yet be told apart from a build that has not shipped — see qr_campaign_capture below.
...
| --- | ---: | ---: | ---: | ---: | --- |
| Michi-Maker | 465 | 316 | 1 | 3 | a code was recorded 2026-08-13 |
| TCGScan | 296 | 223 | 0 | 122 | routes yes, never a code — a zero cannot be told from an unshipped build |
| Doggle | 98 | 97 | 1 | 98 | a code was recorded 2026-08-13 |
| Pickleague | 51 | 48 | 0 | 51 | routes yes, never a code — a zero cannot be told from an unshipped build |
