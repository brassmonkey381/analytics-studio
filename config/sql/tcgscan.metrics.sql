-- TCGScan: per-day DAU and new users, split into real accounts vs anonymous
-- guest sessions. Shares an auth pool with Michi-Maker, so both DAU and
